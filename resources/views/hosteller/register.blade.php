                                                    ...
                                                    <div class="woocommerce">
                                                        <div class="woocommerce-info" style="margin-bottom: 1px">
                                                            ...
                                                            <div class="pull-right">
                                                                <p>Already registered, <a href="{{route('hosteller.login')}}">Click here to sign in</a></p>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <form class="woocomerce-form woocommerce-form-login login multi-submit-prevent" method="POST" action="{{ route('hosteller.register') }}">
                                                                    ...
                                                                    <div class="woocommerce-billing-fields__field-wrapper">
                                                                        ...
                                                                        <p role="radiogroup" class="form-row form-row-last validate-required mt-5" >
                                                                            <label for="role" class="">I am the </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                            <label class="radio-inline" for="inline-radio1">
                                                                                <input type="radio" id="inline-radio1" name="role" value="manager" class="custom-control-input" required>
                                                                                <span aria-hidden="true" class="custom-control-indicator"></span>
                                                                                <span class="custom-control-description">Hostel Manager</span>
                                                                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                            <label class="radio-inline" for="inline-radio2">
                                                                                <input type="radio" id="inline-radio2" name="role" value="owner" class="custom-control-input">
                                                                                <span aria-hidden="true" class="custom-control-indicator"></span>
                                                                                <span class="custom-control-description">Hostel Owner</span>
                                                                            </label>
                                                                            @if ($errors->has('role'))
                                                                                <span class="invalid-feedback">
                                                                                    <strong style="color: #ff0000;">{{ $errors->first('role') }} </strong>
                                                                                </span>
                                                                            @endif
                                                                        </p>
