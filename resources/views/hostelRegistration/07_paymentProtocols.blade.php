                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div id="payment" class="woocommerce-checkout-payment">
                                                                                ...
                                                                                <div class="form-row place-order">
                                                                                    ...
                                                                                    <div class="col-xs-6">
                                                                                        <a href="06_policies.php"><input type="submit" class="button alt" name="woocommerce_checkout_place_order" id="previous" value="Previous" data-value="Previous"></a>
                                                                                    </div>
                                                                                    <div class="col-xs-6">
                                                                                        <a href="../individual_hostel/"> <input type="submit" class="button alt" name="woocommerce_checkout_place_order" id="next" value="Next" data-value="Next"></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
