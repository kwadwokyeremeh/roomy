...
Route::middleware('hvs')->group(function (){
    ...
    Route::post('{hostelName}/updateDate', 'Hosteller\Dashboard\HostellerController@updateDate');
    Route::post('{hostelName}/updateDuration', 'Hosteller\Dashboard\HostellerController@updateDuration');
    Route::get('{hostelName}/editContent', 'Hosteller\Dashboard\HostellerController@editContent');
    Route::post('{hostelName}/updateContent', 'Hosteller\Dashboard\HostellerController@updateContent');
    Route::post('{hostelName}/deleteRoomDescMedia', 'Hosteller\Dashboard\HostellerController@deleteRoomDescMedia');
    Route::post('{hostelName}/updateRoomDescMedia', 'Hosteller\Dashboard\HostellerController@updateRoomDescMedia');
    Route::post('{hostelName}/updateMisc', 'Hosteller\Dashboard\HostellerController@updateMisc');
    Route::post('{hostelName}/deleteMisc', 'Hosteller\Dashboard\HostellerController@deleteMisc');
    ...
    Route::post('{hostelName}/updateRoomDesc', 'Hosteller\Dashboard\HostellerController@updateRoomDesc');
    Route::post('{hostelName}/createRoomDesc', 'Hosteller\Dashboard\HostellerController@createRoomDesc');
    Route::post('{hostelName}/deleteRoomDesc', 'Hosteller\Dashboard\HostellerController@deleteRoomDesc');
    Route::post('{hostelName}/updateRoom', 'Hosteller\Dashboard\HostellerController@updateRoom');
    Route::post('{hostelName}/deleteRoom', 'Hosteller\Dashboard\HostellerController@deleteRoom');
